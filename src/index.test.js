...
describe(`compound variants`, () => {
  test('basic', () => {
    const builder = clb({
      base: 'base',
      compoundVariants: [{ color: 'red', classes: 'neat' }],
    })
  ...
  test('multiple', () => {
    ...
    expect(builder({ color: 'blue', size: 'large', disabled: true })).toBe(
      'base blue large blue large disabled'
    )
  ...
  test('with the defaults', () => {
    const builder = clb({
      ...
      compoundVariants: [{ size: 'sm', classes: 'red sm' }],
    })
  ...
  test('with additional props that do not matter', () => {
    const builder = clb({
      base: 'base',
      compoundVariants: [{ color: 'red', size: 'sm', classes: 'red sm' }],
    })

    expect(builder({ color: 'red', size: 'sm', random: '12345' })).toBe(
      'base red sm'
    )
  })
  ...
  test('option being undefined should use the defaultVariant', () => {
    const builder = clb({
      ...
      compoundVariants: [{ tone: 'neutral', classes: 'neutral' }],
    })
  ...
  test('false null 0', () => {
    const builder = clb({
      ...
      compoundVariants: [
        ...
        { test: 0, more: 5, classes: 'test zero more five' },
        {
          test: undefined,
          more: 5,
          classes: 'test undefined more five',
        },
      ],
    })
    ...
    expect(builder({ test: undefined, more: 5 })).toBe(
      'base test undefined more five'
    )
  })
})
